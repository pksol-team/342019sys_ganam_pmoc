...
<div id="page-content" class="profile2">
	...
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $sample_case_screen->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Sample_case_Screens", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/sample_case_screens/'.$sample_case_screen->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Sample_case_Screens", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.sample_case_screens.destroy', $sample_case_screen->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	*/ ?>
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/sample_case_screens') }}" data-toggle="tooltip" data-placement="right" title="ケースに戻る"><i class="fa fa-chevron-left"></i></a></li>
		<li class="active"><a role="tab" data-toggle="tab" class="active" href="#tab-general-info" data-target="#tab-info"><i class="fa fa-bars"></i> 一般的な情報</a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						@la_display($module, 'customer_name')
						@la_display($module, 'record_type')
						@la_display($module, 'case_name')
						@la_display($module, 'task_name')
						@la_display($module, 'grant_total')
						@la_display($module, 'target_name')
						@la_display($module, 'content_preparation')
						@la_display($module, 'project_proposal_day')
						@la_display($module, 'expiration_date')
						@la_display($module, 'application_amount')
						@la_display($module, 'scheduled_date_1')
						@la_display($module, 'scheduled_date_2')
						@la_display($module, 'scheduled_date_3')
						@la_display($module, 'stop')
						@la_display($module, 'reserved')
						@la_display($module, 'case_close_check')
						@la_display($module, 'remarks')
						@la_display($module, 'final_update_date')
					</div>
				</div>
			</div>
		</div>
