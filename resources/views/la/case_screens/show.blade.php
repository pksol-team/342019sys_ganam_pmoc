...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $case_screen->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Case_Screens", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/case_screens/'.$case_screen->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Case_Screens", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.case_screens.destroy', $case_screen->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/case_screens') }}" data-toggle="tooltip" data-placement="right" title="Back to Case Screens"><i class="fa fa-chevron-left"></i></a></li>
